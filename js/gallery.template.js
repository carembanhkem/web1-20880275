...
templates['gallery-categories-template.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\"nav-item\">\r\n            <a class=\"nav-link disabled ps-0\" href=\"#\" aria-current=\"page\" onclick=\"loadData('gallery', 'gallery-template', 'gallery')\">Show all</a>\r\n        </li>\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"data") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":4,"column":8},"end":{"line":9,"column":17}}})) != null ? stack1 : "");
},"useData":true});
